...
public class RoutingTable {
    private static final String ORIGIN = "origin"; //......................... private instance variables for keys
    ...
    public RoutingTable(){
        ...
        int[] origin11 = { 110, 18, 40, 64 }, port11   = { 4 };
        int[] origin12 = { 110, 18, 40, 20 }, port12   = { 4 };
        int[] origin13 = { 110, 32, 32, 64 }, port13   = { 7 };
        int[] origin14 = { 110, 24, 40, 64 }, port14   = { 9 };
        int[] origin15 = { 110, 24, 40, 80 }, port15   = { 9 };
        int[] origin16 = { 110, 24, 40, 68 }, port16   = { 10 };
        int[] origin17 = { 110, 18, 40, 16 }, port17   = { 10 };
        ...
        int[] mtu16  = { 256 }, dest16  = { 110, 37, 32, 82 };
        ...
        int[][] mtu = { mtu1, mtu2, mtu3, mtu4, mtu5, mtu6,
                        mtu6, mtu7, mtu8, mtu9, mtu10, mtu11,
                        mtu12, mtu13, mtu14, mtu15, mtu16, mtu17
        };

        int[][] dest = { dest1, dest2, dest3, dest4, dest5, dest6,
                         dest7, dest8, dest9, dest10, dest11, dest12,
                         dest13, dest14, dest15, dest16, dest17
        };

        for( int row = 0; row < 17; row++ ){ //........................... loop through each row
    ...
    public static boolean ipExistInTable( String ipAddress ){
        String convertedIP = createIPString(createIPArray(addMaskToAddress(ipAddress))); //... converts the IP with the MASK
        RoutingTable temp = new RoutingTable();

        for( HashMap<String, int[]> entry : temp.getTableRows() ) { //............................. checks each entry
    ...
    // Method to get the destination IP from the destination address
    public static String getDestinationIPFromAddress( String address ){
        String returnIP = "";
        RoutingTable temp = new RoutingTable();
